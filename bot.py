...
CASES = {
    ...
    "grand": {"name": "💎 Гранд кейс", "price": 1500, "items": [
        {"name": "Паласы",    "rarity": "rare",      "emoji": "🔵", "value": 600,  "photo": "AgACAgIAAxkBAAFLHOpqHArXDysbef-5XXvBT-Ft0ao5SwAC2htrGw_44EiHdQABax20cY4BAAMCAAN5AAM7BA"},
        {"name": "Миромаш",   "rarity": "rare",      "emoji": "🔵", "value": 700,  "photo": "AgACAgIAAxkBAAFLHOxqHAr03_MJzsDNdas3I9EndJhTpQAC2xtrGw_44EjHV5kmSYvXVQEAAwIAA3kAAzsE"},
        {"name": "Неколез",   "rarity": "epic",      "emoji": "🟣", "value": 1200, "photo": "AgACAgIAAxkBAAFLHORqHAo7uNHeT9g-2J2KHiYMorBQhgACFx1rG4Ys4EhXfJV1yvl9OQEAAwIAA3kAAzsE"},
        {"name": "Оуджи",     "rarity": "epic",      "emoji": "🟣", "value": 1500, "photo": "AgACAmIAAxkBAAFLHOhqHAqxEXjrYWkTelenzs5Fmf1JpwAC1xtrGw_44EhE_DPhRGS8IgEAAwIAA3kAAzsE"},
        {"name": "Альмеро",   "rarity": "epic",      "emoji": "🟣", "value": 1800, "photo": "AgACAmIAAxkBAAFLHO1qHAr0H14TSvgWf_jpxy5NR2pUqQAC3BtrGw_44Ej0jOHjWscpcAEAAwIAA3kAAzsE"},
        {"name": "Красный орел", "rarity": "legendary", "emoji": "🟡", "value": 3500, "photo": "AgACAmIAAxkBAAFLHOZqHAqOmlCFYgAB3yqHHcOGvZCWiBoAAtUbaxsP-OBIJoYnJhsO66ABAAMCAAN5AAM7BA"},
        {"name": "Гранд кейс", "rarity": "legendary", "emoji": "🟡", "value": 5000, "photo": "AgACAmIAAxkBAAFLHOJqHAntBVF1VlkWolG5q5o6bE3XzAACGR1rG4Ys4Eg9UcQ_kEv6ZAEAAwIAA3kAAzsE"},
...
async def do_open_case(cb: CallbackQuery, bot: Bot, key: str, x2: bool):
    ...
    if photo_id:
        # Удаляем анимацию и отправляем фото
        try:
            await msg.delete()
        except Exception:
            pass
        ...
        await msg.edit_text(result_text, reply_markup=b.as_markup())

    # ── ПОСЛЕ показа результата — уведомления о заданиях и достижениях ──
