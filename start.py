BOT_TOKEN = "ВАШ_ТОКЕН_ОТ_BOTFATHER"  # Вставь сюда токен
...
DAILY_BONUS = 150  # монет за ежедневный бонус
START_BONUS = 300  # монет при регистрации
